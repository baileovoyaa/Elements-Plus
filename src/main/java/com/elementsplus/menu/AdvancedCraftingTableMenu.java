...
public class AdvancedCraftingTableMenu extends RecipeBookMenu<CraftingInput, CraftingRecipe> {
    ...
    public AdvancedCraftingTableMenu(int i, Inventory inventory) {
        this(i, inventory, ContainerLevelAccess.NULL);
    }

    public AdvancedCraftingTableMenu(int i, Inventory inventory, ContainerLevelAccess containerLevelAccess) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, ModBlocks.ADVANCED_CRAFTING_TABLE);
    }
