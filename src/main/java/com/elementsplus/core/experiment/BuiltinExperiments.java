...
public class BuiltinExperiments {
    ...
    ), BuiltinCircuitComponents.AMPLIFIER));
    ...
    ), BuiltinCircuitComponents.AND_GATE));
    ...
    public static final CircuitExperiment OR_GATE = register("or_gate", BuiltinCircuitComponents.OR_GATE.getIcon(), new CircuitExperiment(List.of(
            ...
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(1), "B", new PinValue(1)), Map.of("Y", new PinValue(1)))
    ), BuiltinCircuitComponents.OR_GATE));
    ...
    ), BuiltinCircuitComponents.NOT_GATE));
    ...
    public static final CircuitExperiment HALF_ADDER = register("half_adder", null, new CircuitExperiment(List.of(
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(0), "B", new PinValue(0)), Map.of("S", new PinValue(0), "C", new PinValue(0))),
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(0), "B", new PinValue(1)), Map.of("S", new PinValue(1), "C", new PinValue(0))),
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(1), "B", new PinValue(0)), Map.of("S", new PinValue(1), "C", new PinValue(0))),
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(1), "B", new PinValue(1)), Map.of("S", new PinValue(0), "C", new PinValue(1)))
    )));

    public static final CircuitExperiment FULL_ADDER = register("full_adder", null, new CircuitExperiment(List.of(
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(0), "B", new PinValue(0), "C", new PinValue(0)), Map.of("S", new PinValue(0), "C", new PinValue(0))),
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(0), "B", new PinValue(0), "C", new PinValue(1)), Map.of("S", new PinValue(1), "C", new PinValue(0))),
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(0), "B", new PinValue(1), "C", new PinValue(0)), Map.of("S", new PinValue(1), "C", new PinValue(0))),
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(0), "B", new PinValue(1), "C", new PinValue(1)), Map.of("S", new PinValue(0), "C", new PinValue(1))),
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(1), "B", new PinValue(0), "C", new PinValue(0)), Map.of("S", new PinValue(1), "C", new PinValue(0))),
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(1), "B", new PinValue(0), "C", new PinValue(1)), Map.of("S", new PinValue(0), "C", new PinValue(1))),
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(1), "B", new PinValue(1), "C", new PinValue(0)), Map.of("S", new PinValue(0), "C", new PinValue(1))),
            new ConstantCombinationalTestCase(Map.of("A", new PinValue(1), "B", new PinValue(1), "C", new PinValue(1)), Map.of("S", new PinValue(1), "C", new PinValue(1)))
    )));
