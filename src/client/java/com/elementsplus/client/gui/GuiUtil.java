    ...
    public static void drawSubPanel(GuiGraphics guiGraphics, int x1, int y1, int x2, int y2, int colorMultiply, SubPanelType type) {
        ...
        switch (type) {
            ...
            case CONCAVE -> {
                ...
                int color2 = screenColor(0xFFE0E0E0, colorMultiply);
                fillContext.fillRelative(0, 0, -1, -1, colorMultiply);
                fillContext.fillRelative(-2, 1, -1, -1, color2);
                fillContext.fillRelative(1, -2, -1, -1, color2);
                fillContext.fillRelative(0, 0, 1, -2, color1);
                fillContext.fillRelative(0, 0, -2, 1, color1);
            }
            case BOX -> {
