...
public class AdvancedCraftingTableScreen extends AbstractContainerScreen<AdvancedCraftingTableMenu> implements RecipeUpdateListener {
    private static final ResourceLocation CRAFTING_TABLE_LOCATION = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/gui/advanced_crafting_table.png");
    private final RecipeBookComponent recipeBookComponent = new RecipeBookComponent();
    private boolean widthTooNarrow;

    public AdvancedCraftingTableScreen(AdvancedCraftingTableMenu craftingMenu, Inventory inventory, Component component) {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new ImageButton(this.leftPos + 145, this.height / 2 - 85, 20, 18, RecipeBookComponent.RECIPE_BUTTON_SPRITES, button -> {
            this.recipeBookComponent.toggleVisibility();
            this.leftPos = this.recipeBookComponent.updateScreenPosition(this.width, this.imageWidth);
            button.setPosition(this.leftPos + 145, this.height / 2 - 85);
        }));
    ...
    public boolean keyPressed(int i, int j, int k) {
        return this.recipeBookComponent.keyPressed(i, j, k) || super.keyPressed(i, j, k);
    }
    ...
    public boolean mouseClicked(double d, double e, int i) {
        if (this.recipeBookComponent.mouseClicked(d, e, i)) {
            ...
            return this.widthTooNarrow && this.recipeBookComponent.isVisible() || super.mouseClicked(d, e, i);
        }
    }
